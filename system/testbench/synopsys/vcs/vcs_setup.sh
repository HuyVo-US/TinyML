...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/mlp_accelerator.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/mac_unit.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/weight_rom.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_led.v \
